...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/trivechaincore-node:/insight/node_modules/trivechain/trivechain-insight-ui/trivechaincore-node`,
        `${rootPath}/po:/insight/node_modules/trivechain/trivechain-insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/trivechain/trivechain-insight-ui/public`,
      ],
    };
    ...
    await masterNode.trivechainCore.getApi().generate(15);
  });
  ...
  describe('Home Page', () => {
    ...
    it('should be able search by block number', async () => {
      ...
      expect(blockReward).equal('500 TRVC');
